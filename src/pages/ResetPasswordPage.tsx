...
import { Lock, CheckCircle, Loader2, Code2 } from "lucide-react";
        ...
        <div className="relative flex flex-col items-center justify-center min-h-screen bg-gray-950 text-white overflow-hidden selection:bg-purple-500/30">
            ...
            <div className="relative z-10 w-full max-w-md px-6">
                                ...
                                <div className="flex items-center justify-center gap-2">
                                    {loading ? (
                                        ...
                                        <>
                                            ...
                                            <CheckCircle size={18} className="group-hover:text-green-300 transition-colors" />
                                        </>
                                    )}
                                </div>
                                {/* Shine effect */}
                ...
                <p className="text-center text-gray-600 text-xs mt-8">
                    © 2025 Language Hub. Security Check.
                </p>
            </div>
        </div>
    );
